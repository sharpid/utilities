...
template <typename T_TYPE, typename T_FUNC, typename T_RET, typename ... T_ARGS >
...
template<typename T_TYPE, typename T_FUNC, typename T_RET, typename ...T_ARGS>
inline void MessageDispatcher<T_TYPE, T_FUNC, T_RET, T_ARGS...>::RegisterMessage(T_TYPE _type, T_FUNC _func)
{
	message_map_.emplace(_type, _func);
}

template<typename T_TYPE, typename T_FUNC, typename T_RET, typename ...T_ARGS>
inline T_RET MessageDispatcher<T_TYPE, T_FUNC, T_RET, T_ARGS...>::DispatchMessage(T_TYPE _type, T_ARGS ... _args)
{
